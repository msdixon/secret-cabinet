...
Coverage as an exemplar is therefore counted by distinct `author`, not by union of `members`: 32 of 38 roster members, not the 33 that `members` gives. (The roster grew from 33 to 38 in the 2026-08-10 TV-personas addition — see the 2026-08-10 #35a entry in STATUS.md for the five new members this increment covered.)
