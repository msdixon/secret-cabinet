 ...
 *
 * `beforeEval(window)`, if given, runs after the window exists but before
 * the module is evaluated — for the rare case a module reads state (e.g.
 * localStorage) at load time, which needs seeding before eval to observe
 * rather than after.
 *
 ...
 */
function loadPublicModule(fileName, bodyHtml = '', beforeEval) {
